...
const AppTopNav = (): JSX.Element => {
    ...
    return (
        ...
        >
            <button type="button" onClick={goBackClick} className="window-top-navigation-buttons buttons-left" >
                <ArrowBackIcon className="window-top-navigation-buttons-icons" />
            </button>
            <button type="button" onClick={goForvardClick} className="window-top-navigation-buttons buttons-left">
                <ArrowForwardIcon className="window-top-navigation-buttons-icons" />
            </button>
            <div className="window-top-navigation-right">
                <button type="button" onClick={minimizeWindow} className="window-top-navigation-buttons minimize-button">
                    <NavMinimizeIcon className="window-top-navigation-buttons-icons minimize" />
                </button>
                <button type="button" onClick={maximizeWindow} className="window-top-navigation-buttons maximize-button">
                    <NavMaximizeIcon className="window-top-navigation-buttons-icons" />
                </button>
                <button type="button" onClick={closeWindow} className="window-top-navigation-buttons">
