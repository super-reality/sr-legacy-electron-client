...
export const setAppLoaded = (loaded: boolean): AppLoadedAction => ({
  type: SET_APP_LOADED,
  loaded,
});

export const setAppLoadPercent = (
  loadPercent: number
): AppLoadPercentAction => ({ type: SET_APP_LOADING_PERCENT, loadPercent });
// onboarding progress
export const setAppOnBoardingStep = (
  onBoardingStep: number
...
export const setAppSpecificOnBoardingStep = (
  onBoardingStep: number,
  isTutorial: boolean
): AppOnBoardingStepAction => ({
